<template>
    <div>
        <el-form ref="formRef" :model="pageForm" :rules="pageFormRule" label-width="80px">
            ...
            <el-form-item>
                <el-button type="primary" @click="editSubmit('formRef')" :loading="submitLoading">提交</el-button>
...
<script>
import { siteList as siteListApi, templateList as templateListApi, pageUpdate, pageById } from '../api/cms'
export default {
    data() {
        return {
            pageId: '',
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    this.$confirm('确认是否提交?', '提示', {
                        ...
                        pageUpdate(this.pageId, this.pageForm).then(res => {
                            if (res.success) {
